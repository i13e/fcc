...
echo "$($PSQL "SELECT g.year, t.name FROM teams t INNER JOIN games g
               ON team_id = g.winner_id and g.round = 'Final' ORDER BY g.year")"
